...
export default function FiloHakedisWizard() {
    ...
    const downloadHakedisTemplate = useCallback(() => {
        ...
        applyHakedisSheetBranding(XLSX, wb, ws, "Filo İskontolu Hakediş Şablonu");
    ...
    const downloadSeferlerTemplate = useCallback(() => {
        ...
        applyHakedisSheetBranding(XLSX, wb, ws, "Filo İskontolu Seferler Şablonu");
    ...
    const downloadExcel = (data, fileName, sheetName = "Veriler") => {
        try {
            ...
            applyHakedisSheetBranding(XLSX, workbook, worksheet, "Filo İskontolu Hakediş Raporu");
    ...
    const exportAndRedirect = async () => {
        ...
        try {
            ...
            applyHakedisSheetBranding(XLSX, wb, ws, "Filo İskontolu Gider Çıktısı");
    ...
    return (
        <Box className="hakedis-premium-page filo-iskontolu-page" sx={{ minHeight: '100vh', bgcolor: theme.bg, color: theme.text, py: 4 }}>
