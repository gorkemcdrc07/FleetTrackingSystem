    ...
    return (
        <div className={`aktif-page trips-modern density-${density}`}>
            ...
            <section className="trip-sync-bar" aria-label="Tarih ve veri yenileme">
                ...
                <button className="tms-refresh-btn" onClick={tmsdenCekVeKaydet} disabled={loading||syncing}><RefreshCw size={16} className={syncing?"trip-spin":""}/>{syncing?"Yenileniyor…":"TMS’den Yenile"}</button>
            </section>
