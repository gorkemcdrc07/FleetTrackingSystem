import { LayoutDashboard, Satellite, Route, Clock3 } from "lucide-react";
import "./Detay.css";
export default function Sekmeler({activeTab,onChange}) {
 const tabs=[
  {key:"genel",title:"Genel Bakış",icon:LayoutDashboard},
  {key:"mobiliz",title:"Canlı Takip",icon:Satellite},
  {key:"rota",title:"Rota & Duraklar",icon:Route},
  {key:"eta",title:"ETA",icon:Clock3}
 ];
