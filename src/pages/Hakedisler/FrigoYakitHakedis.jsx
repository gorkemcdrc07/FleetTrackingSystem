...
const downloadXlsxTemplate = async (fileName, sheetName, headers, sampleRows) => {
    ...
    applyHakedisWorkbookBranding(workbook, { title: "Frigo Yakıt Hakediş Raporu" });
...
export default function FrigoYakitHakedis() {
    ...
    return (
        <Box className="hakedis-premium-page frigo-yakit-page" sx={{ p: { xs: 2, md: 3 }, color: DARK.text, bgcolor: DARK.pageBg, minHeight: '100vh' }}>
